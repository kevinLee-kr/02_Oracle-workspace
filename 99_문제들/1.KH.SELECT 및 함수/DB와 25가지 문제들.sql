...
SELECT EMP_NAME, SYSDATE - HIRE_DATE AS "근무일수1"
FROM EMPLOYEE; --소숫점 버림 함수 아직 안배움, 오늘-입사일 조회 아직 안배움.
...
SELECT EMP_NAME AS "사원 명" ,DEPT_CODE AS "부서코드", (SALARY+SALARY*BONUS)*12 AS "보너스포함 연봉 합"
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5';
